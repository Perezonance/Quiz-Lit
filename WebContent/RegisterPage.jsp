...
<html>
	...
	<body>
		<div class="login-page">
			<%
				if(session.getAttribute("emailExists").equals("true")){
					out.print("<p> Uh Oh! Looks like that Email is already in use.</p>");
				}
				if(session.getAttribute("passMatch").equals("false")){
